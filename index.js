document.getElementById("animatedDiv").addEventListener("click", function () {
  ...
  document.getElementById("upper-final-box").style.animation =
    "moveUp 0.5s ease-in-out";
  document
    .getElementById("upper-final-box")
    .addEventListener("animationend", () => {
      ...
      document.getElementById("nonAnimatedDiv").style.background =
        "rgb(255, 182, 193)";
    });
  //this.style.animation = "moveDownFade 1s ease-in-out forwards";
...
function yesButtonClick() {
  ...
  document.getElementById("filler-div").style.animation =
    "moveUpFadeIn 0.5s ease-in";
}
